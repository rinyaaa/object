...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(
                "Input: [\"Java\", \"is\", \"fun\", null, \"Programming\", \"\"], minLength=3, Expected: 3, Actual: " +
        ...
        System.out.println("Input: \"Java\", n=10, Expected: \"JAVA\", Actual: "
                + textManipulator.getFirstNCharsAsUpperCase("Java", 10));
        // テストケース11: 通常の文字列、nが文字列長と等しい
        System.out.println(
                "Input: \"Hi\", n=2, Expected: \"HI\", Actual: " + textManipulator.getFirstNCharsAsUpperCase("Hi", 2));
        // テストケース12: null文字列 (早期リターンの対象)
        System.out.println(
                "Input: null, n=3, Expected: \"\", Actual: " + textManipulator.getFirstNCharsAsUpperCase(null, 3));
        // テストケース13: 空文字列 (早期リターンの対象)
        System.out.println(
                "Input: \"\", n=3, Expected: \"\", Actual: " + textManipulator.getFirstNCharsAsUpperCase("", 3));
        // テストケース14: nが0 (早期リターンの対象)
        System.out.println("Input: \"Test\", n=0, Expected: \"\", Actual: "
                + textManipulator.getFirstNCharsAsUpperCase("Test", 0));
        // テストケース15: nが負の数 (早期リターンの対象)
        System.out.println("Input: \"Test\", n=-1, Expected: \"\", Actual: "
                + textManipulator.getFirstNCharsAsUpperCase("Test", -1));
    }
}